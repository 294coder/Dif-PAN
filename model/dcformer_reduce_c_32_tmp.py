...
@register_model("dcformer_reduce_c32")
class DCFormer_Reduce_C32(BaseModel):
    def __init__(
        self,
        spectral_num,
        mode="C",
        ...
        super(DCFormer_Reduce_C32, self).__init__()
...
if __name__ == "__main__":
    ...
    net = DCFormer_Reduce_C32(31, "C", block_list=(4, (4, 3), (4, 3, 2))).cuda(1)
    ...
    lms = torch.randn(1, 31, 128, 128).cuda(1)
    pan = torch.randn(1, 3, 128, 128).cuda(1)
