...
class BasicBlock2(nn.Module):
    ...
    def __init__(self, inplanes,
        ...
        self.block = PanFormerEncoderLayer(inplanes, heads, attn_drop, mlp_ratio, mlp_drop=mlp_drop,
                                           drop_path=drop_path, attn_type=attn_type,
...
@register_model('dcformer_base')
class DCFormer(BaseModel):
    def __init__(self, spectral_num, mode="SUM"):
        super(DCFormer, self).__init__()
...
@register_model('dcformer_dynamic')
class DCFormerDynamicConv(BaseModel):
    def __init__(self, spectral_num, mode="SUM"):
        super(DCFormerDynamicConv, self).__init__()
        self.first_fuse = mode
        if mode == "SUM":
            print("repeated sum head")
            init_channel = spectral_num
