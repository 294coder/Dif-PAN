    ...
    def __init__(
        ...
        if self.num_branches == 3:
            ...
            self.fuse_block_b0_b1 = PanFormerEncoderLayer(
                (64, 32), 8, 0.2, 2, attn_type="XC", drop_path=0.2
            )
            self.fuse_block_b1_b2 = PanFormerEncoderLayer(
                (128, 64), 8, 0.2, 2, attn_type="XC", drop_path=0.2
            )
...
@register_model('dcformer_abla_only_cross_branch_xca')
class DCFormerOnlyCrossBranchXCA(BaseModel):
    def __init__(self, spectral_num, mode="SUM"):
        super(DCFormerOnlyCrossBranchXCA, self).__init__()
...
if __name__ == '__main__':
    ...
    # params: 2.915M
    # FLOPs: 3.489G
    net = DCFormerOnlyCrossBranchXCA(31, mode='C')
