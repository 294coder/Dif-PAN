...
@register_model('dcformer_woo')
class DCFormer_DPW_WOO(BaseModel):
    def __init__(self, spectral_num, mode="SUM", channel_list=(16, (8, 16), (8, 16, 32))):
        super(DCFormer_DPW_WOO, self).__init__()
...
if __name__ == '__main__':
    ...
    ms = torch.randn(1, 3, 64, 64).cuda()
    mms = torch.randn(1, 3, 128, 128).cuda()
    lms = torch.randn(1, 3, 256, 256).cuda()
    pan = torch.randn(1, 1, 256, 256).cuda()

    # params: 1.92M
    # FLOPs: 4.921G
    net = DCFormer_DPW_WOO(3, 'C').cuda()
