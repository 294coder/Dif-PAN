...
class ChannelFuseBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, num_res=1, stride=1, downsample=None):
        ...
        self.conv_up = conv3x3(31, planes, stride)
        self.epsilon = 1e-4
    ...
    def __init__(
        ...
        if self.num_branches == 3:
            ...
            self.b1_down = nn.Sequential(
                ...
                nn.Conv2d(
                    128, 128, kernel_size=3, stride=2, padding=1, bias=False, groups=128  # 4
                ),
                nn.BatchNorm2d(128),
                nn.ReLU(),
            )
...
@register_model('dcformer_abla_only_cross_branch_mwa')
class DCFormerOnlyCrossBranchMWSA(BaseModel):
    def __init__(self, spectral_num, mode="SUM"):
        super(DCFormerOnlyCrossBranchMWSA, self).__init__()
...
if __name__ == '__main__':
    ...
    # params: 2.915M
    # FLOPs: 3.489G
    net = DCFormerOnlyCrossBranchMWSA(31, mode='C')
