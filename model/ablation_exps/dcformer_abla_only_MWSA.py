# Copyright (c) ZiHan Cao, Wu Xiao, LJ Deng (UESTC-MMHCISP). All Rights Reserved.

# only cross-scale MWSA
# Tab.7 row 3
    ...
    def __init__(
        ...
        for i in range(num_res):
            ...
            self.res_block.append(
                BasicBlock(
                    planes, planes, stride, downsample
                )
            )
...
@register_model("dcformer_mwsa_only_mwsa")
