...
from model.ablation_exps.attention import MultiScaleWindowCrossAttention
from model.ablation_exps.panformer import PanFormerEncoderLayer
    ...
    def __init__(
        ...
        for i in range(num_res):
            ...
            self.res_block.append(
                BasicBlock(planes, planes, stride, downsample)
            )
    ...
    def __init__(
        ...
        if self.num_branches == 2:
            ...
            self.cfs_layers = ChannelFuseBlock(
                ...
                num_heads=num_heads[-1] if isinstance(num_heads, (list, tuple)) else num_heads,
            )
...
@register_model("dcformer_mwsa_only_cross_branch_XCA")
class DCFormerMWSA(BaseModel):
    ...
    def __init__(
        ...
        num_channels = [
            self.channels_list[1][i] * BasicBlock.expansion
        ...
        transition_num_channels = [
            self.channels_list[2][i] * BasicBlock.expansion
