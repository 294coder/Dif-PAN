...
from model.module.helper_func import exists, default
...
def linear_attention(q, k, v):
    ...
    D_inv = 1.0 / torch.einsum("...nd,...d->...n", q, k_cumsum.type_as(q))  # [b, h, n, d] * [b, h, d] -> [b, h, n]
    context = torch.einsum("...nd,...ne->...de", k, v)  # [b, h, n, d] @ [b, h, n, e] -> [b, h, d, e]
