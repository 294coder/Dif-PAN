...
#  -b 40 --device 'cuda:1' --dataset 'wv3' \
...
## pannet arch
 ...
 --loss l1ssim --val_n_epoch 10 --comment 'panRWKV wv3 middle large ssm kernel' \
 --log_metrics \
 --logger_on \
...
# -b 128 --device 'cuda:1' --dataset 'hisi-houston' --logger_on --log_metrics \
# --warm_up_epochs 0 --num_worker 0 -e 2000 --aug_probs 0. 0. \
# --loss 'l1ssim' --val_n_epoch 10 --comment 'restfnet houston' \
# --ergas_ratio 4 \
