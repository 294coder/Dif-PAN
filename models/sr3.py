...
class FastFreqCondInjection(nn.Module):
    def __init__(
        self,
        fea_dim,
        cond_dim,
...
class WrappedCondInj(nn.Module):
    def __init__(
        ...
        self.fft_cond_inj = FreqCondInjection(
            fea_dim,
            cond_dim,
            qkv_dim,
            dim_out,
...
class ResnetBlocWithAttn(nn.Module):
    def __init__(
        ...
        *,
        ...
        # if exists(with_freq):
        #     self.cond_inj_freq = FreqCondInjection(
        #         dim,
        #         cond_dim,
        #         dim,
        #         dim_out,
        ...
        #     )
            ...
            #     ffn_drop_path=0.2,
            # )
            # print("use condition injection module in rgb and frequency space")
